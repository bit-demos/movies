...
Api Hooks created with this factory will connect to and consume the `useXyzContext` of any api context that is based on the [rest-ful API context provider component](@learn-bit-react/movies.context.api-context-provider),
