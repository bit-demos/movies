...
The factory connects to the `useApiContext` of any api context which is based on the [rest-ful API context provider component](@learn-harmony/movies.context.api-context-provider),
